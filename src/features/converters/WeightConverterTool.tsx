...
export default function WeightConverterTool() {
  ...
  const convert = (value: string, fromUnit: string, toUnit: string) => {
    ...
    if (isNaN(val)) return '';
    const toBase = {"kg":1,"g":0.001,"mg":0.000001,"t":1000,"lb":0.45359237,"oz":0.028349523125};
  ...
  return (
    <ToolShell 
      ...
      description="Convert weights between kilograms, grams, milligrams, metric tons, pounds, and ounces." 
      category="converters"
