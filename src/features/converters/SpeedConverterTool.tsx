...
export default function SpeedConverterTool() {
  ...
  const [unit2, setUnit2] = useState('kmh');
  ...
  const convert = (value: string, fromUnit: string, toUnit: string) => {
    ...
    if (isNaN(val)) return '';
    const toBase = {"ms":1,"kmh":0.277778,"mph":0.44704,"kn":0.514444};
  ...
  return (
    <ToolShell 
      ...
      description="Convert speeds between meters per second, kilometers per hour, miles per hour, and knots." 
      category="converters"
