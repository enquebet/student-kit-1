...
export default function AreaConverterTool() {
  ...
  const [unit1, setUnit1] = useState('sqm');
  const [unit2, setUnit2] = useState('sqkm');
  ...
  const convert = (value: string, fromUnit: string, toUnit: string) => {
    ...
    if (isNaN(val)) return '';
    const toBase = {"sqm":1,"sqkm":1000000,"sqft":0.092903,"sqyd":0.836127,"ac":4046.86,"ha":10000};
  ...
  return (
    <ToolShell 
      ...
      description="Convert areas between square meters, square kilometers, square feet, square yards, acres, and hectares." 
      category="converters"
