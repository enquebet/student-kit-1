...
export default function LowPassFilterTool() {
  ...
  return (
    <ToolShell title="Low-Pass Filter Calculator" description="Calculate the cut-off frequency of passive RC and RL low-pass filters." category="engineering" seoTitle="Low-Pass Filter Calculator | RC & RL Cut-off Frequency" seoDescription="Free online calculator for passive low-pass filters. Calculate the -3dB cut-off frequency for RC and RL circuits instantly.">
        ...
        {res && (
          <div className="mt-8 bg-indigo-50 p-6 rounded-xl border border-indigo-100">
            ...
            <div className="bg-white p-6 rounded-lg border text-center">
              ...
              <p className="text-xs text-gray-500 mt-3 font-medium">At this frequency, the output signal is attenuated by -3dB (70.7% of the input voltage).</p>
            </div>
          </div>
        )}
      </div>
